...
2. Fill form:
   ...
   - Slug: cinderella-sharons
   - Industry: salon
   - Theme: (auto-filled by Smart Defaults, can override)
   - Layout: (auto-filled by Smart Defaults, can override)
   - Hero Variant: (auto-filled, can override)
   - Phone: +91 99679 36773
   - Address: Shop No. 3, Pump House, Andheri East, Mumbai
3. Click "Create Site"
...
## ✅ Example `config_json` Shape (Stored in DB)

This is the structure generated by the recommendation + content engines and stored in `sites.config_json`:

```json
{
  "site": {
    "id": "cinderella-sharons",
    "slug": "cinderella-sharons",
    "name": "Cinderella Sharon's Rose Beauty Salon",
    "industry": "salon",
    "theme": "luxury",
    ...
    "components": { "hero": "heroB", "services": "servicesA" }
  },
  "salon": {
    "id": "cinderella-sharons",
    "slug": "cinderella-sharons",
    "name": "Cinderella Sharon's Rose Beauty Salon",
    "tagline": "Premium beauty, crafted with care.",
    "hero": { "backgroundImage": "/images/hero-default.jpg", "overlayOpacity": 0.55 },
    "about": { "headline": "About Cinderella Sharon's Rose Beauty Salon", "description": "…", "yearsInBusiness": 8, "clientsSatisfied": "2,500+", "highlights": [] },
    "services": [{ "id": "salon-service-1", "name": "Hair Cutting", "price": "₹500 - ₹2000" }],
    "gallery": [{ "id": "salon-gallery-1", "title": "Signature Work", "image": "/images/placeholder-1.jpg" }],
    "offers": [{ "id": "salon-offer-1", "title": "New Client Offer", "code": "WELCOME10" }],
    "reviews": [{ "id": "salon-review-1", "name": "Aarav", "rating": 5 }],
    "location": { "address": "…", "phone": "…", "whatsapp": "…", "googlePlaceId": "…" }
  }
}
```
